...
class Ui:
    ...
    async def init(self, variables, unique_object_id):
        ...
        variables = await self.data["variables"].get("")
        ...
        """
        device = await self.data["variables"].get("device/object")
        self.data["device"] = device.value

        console = await self.data["variables"].get("console/object")
        self.data["console"] = console.value

        moment = await self.data["variables"].get("moment/object")
        self.data["moment"] = moment.value

        settings = await self.data["variables"].get("settings/object")
        self.data["settings"] = settings.value

        identifier = await self.data["variables"].get("identifier/object")
        self.data["identifier"] = identifier.value

        scheduler = await self.data["variables"].get("scheduler/object")
        self.data["scheduler"] = scheduler.value

        loader = await self.data["variables"].get("loader/object")
        self.data["loader"] = loader.value
        """
