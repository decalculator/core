...
# Fichier : logs.py
# Rôle    : Ce fichier implémente la classe Logs, qui est utile
...
# Import des modules requis par la classe Logs.
import asyncio

from core.modules.path.path import *
from core.modules.json.json import *

# Définition de la classe Logs.
class Logs:

    # Déclaration de la méthode __init__.
    def __init__(
        self,
