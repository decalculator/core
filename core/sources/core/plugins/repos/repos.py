...
# Fichier : repos.py
# Rôle    : Ce fichier implémente la classe Repos, qui est utile
#           pour la gestion de dépôts.
...
# Import des modules requis par la classe Repos.
import asyncio
...
class Repos:
    ...
    def __init__(
        ...
        Rôle :
            Il s'agit de la méthode d'initialisation de la classe Repos,
        ...
        # Récupération du chemin de configuration des dépôts depuis les
        # paramètres.
        self.config_path = settings.get(Path("repos_config"))
