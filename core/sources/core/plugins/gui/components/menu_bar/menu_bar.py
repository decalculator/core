...
class MenuBar:
    def __init__(self, loop, pid_manager: PidManager, device: Device, scheduler: Scheduler, parent: Gui, languages: Languages, configuration: DynamicValue, filesystem: Filesystem, settings: Settings):
