...
# Fichier : representation.py
# Rôle    : Ce fichier implémente la classe Representation, qui est utile
#           pour la gestion de représentations.
...
# Import des modules requis par la classe Representation.
import asyncio

from core.modules.path.path import *
from core.modules.json.json import *

# Définition de la classe Representation.
class Representation:
    ...
    def __init__(
        ...
        Rôle :
            ...
            Representation, elle assigne aux attributs leurs valeurs, et
