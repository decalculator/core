...
# Fichier : device.py
# Rôle    : Ce fichier implémente la classe Device, qui est utile
#           pour récupérer des informations sur l'appareil courant.
...
# Import des modules requis par la classe Device.
import asyncio
import platform
import pyautogui
...
# Définition de la classe Device.
class Device:
    ...
    def __init__(
        ...
        Rôle :
            Il s'agit de la méthode d'initialisation de la classe Device,
    ...
    # Déclaration de la signature de la méthode get_os.
    def get_os(self):
        """
        Type de méthode :
            Synchrone.
        ...
        Sortie :
            os (list) :
                Description : Une liste contenant le nom du système
                    d'exploitation, sa version majeure, et sa version
                    complète.

        Rôle :
            Récupère les informations du système d'exploitation de
            l'appareil courant.
        """
    ...
    # Déclaration de la signature de la méthode get_resolution.
    def get_resolution(self):
        ...
        Sortie :
            resolution (tuple) :
                Description : Un tuple contenant la largeur et la hauteur
                    de l'écran en pixels.

        Rôle :
            Récupère la résolution de l'écran de l'appareil courant.
        """

        # Récupère la largeur et la hauteur de l'écran.
        width, height = pyautogui.size()

        # Retourne la résolution sous forme de tuple.
        return (width, height)